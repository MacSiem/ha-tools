      ...
      <div class="card">
        <div class="header">
          ...
          <div>
            ...
            <div class="header-sub">${recipientDisplay} \u00A0\u2022\u00A0 <span id="price-display" style="cursor:pointer;color:var(--pr);border-bottom:1px dashed var(--pr)" title="${L ? 'Kliknij aby zmieni\u0107' : 'Click to change'}">${this._config.currency} ${this._getTariffLabel()} \u270E</span></div>
          </div>
        </div>
        <div class="tabs">
