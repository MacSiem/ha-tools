...
class HAVacuumWaterMonitor extends HTMLElement {
  ...
  --bento-bg: var(--bento-card);
  --bento-card: var(--bento-bg);
  --bento-border: var(--bento-border);
  --bento-text: var(--bento-text);
  --bento-text-secondary: var(--bento-text-secondary);
  --bento-text-muted: var(--bento-text-muted);
}
