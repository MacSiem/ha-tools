  ...
  static get _translations() {
    return {
      ...
      pl: {
        ...
        deviceBreakdown: 'Porównuj zużycie energii na poziomie urządzenia.',
...
${this._getStyles()}
    ...
    return `
      <style>${window.HAToolsBentoCSS || ""}
        ...
        @media (prefers-color-scheme: dark) {
          :host { background: var(--bento-bg, #0f172a); }
        }
        @keyframes fadeSlideIn { from { opacity: 0; transform: translateY(8px); } to { opacity: 1; transform: translateY(0); } }
        @keyframes spin { to { transform: rotate(360deg); } }
        .panel-root { display: flex; flex-direction: column; height: 100%; background: var(--bento-bg); }
        .panel-header { padding: 24px 24px 16px; border-bottom: 1px solid var(--bento-border); background: var(--bento-card); }
        ...
        .tab-bar { display: flex; gap: 4px; border-bottom: 2px solid var(--bento-border); padding: 0 24px; background: var(--bento-card); overflow-x: auto; scrollbar-width: none; }
        ...
        .tab-btn:hover { color: var(--bento-primary); background: rgba(59,130,246,.1); }
        ...
        .stat-card { background: var(--bento-bg); border: 1px solid var(--bento-border); border-radius: var(--bento-radius-sm, 6px); padding: 14px; text-align: center; min-width: 0; overflow: hidden; }
        .stat-card:hover { box-shadow: var(--bento-shadow-md, 0 1px 3px rgba(0,0,0,.05)); }
        ...
        .stat-sub { font-size: 11px; color: var(--bento-text-secondary, #94A3B8); margin-top: 3px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
        .recommendation { background: rgba(59,130,246,.1); border: 1px solid rgba(59,130,246,.2); border-radius: var(--bento-radius-sm, 6px); padding: 14px 16px; font-size: 13px; color: var(--bento-text); margin-bottom: 16px; display: flex; align-items: flex-start; gap: 10px; }
        ...
        .trend-up { background: rgba(239,68,68,.1); color: var(--bento-error, #EF4444); }
        .trend-down { background: rgba(16,185,129,.1); color: var(--bento-success, #10B981); }
        ...
        .device-row { display: flex; align-items: center; gap: 8px; padding: 8px 10px; border-radius: var(--bento-radius-sm, 6px); transition: background .15s; }
        .device-row:hover { background: rgba(59,130,246,.1); }
        ...
        .chart-container { position: relative; height: 240px; margin-bottom: 12px; background: var(--bento-card); border: 1px solid var(--bento-border); border-radius: var(--bento-radius-sm, 6px); padding: 16px; box-shadow: var(--bento-shadow-md, 0 1px 3px rgba(0,0,0,.05)); }
        ...
        .tip-card { background: var(--bento-card); border: 1px solid var(--bento-border); border-radius: var(--bento-radius-sm, 6px); padding: 14px; font-size: 13px; color: var(--bento-text); box-shadow: var(--bento-shadow-md, 0 1px 3px rgba(0,0,0,.05)); }
        ...
        .error-msg { padding: 16px; background: rgba(239,68,68,.1); border-left: 4px solid var(--bento-error, #EF4444); border-radius: var(--bento-radius-sm, 6px); font-size: 13px; color: var(--bento-error, #EF4444); }
        .no-sensors { padding: 40px 24px; text-align: center; color: var(--bento-text-secondary); font-size: 13px; }
        button { font-family: 'Inter', sans-serif; font-size: 13px; font-weight: 500; border-radius: var(--bento-radius-sm, 6px); transition: all .2s; cursor: pointer; border: none; padding: 8px 14px; background: var(--bento-primary); color: white; }
        ...
        .refresh-btn:hover { color: var(--bento-primary); background: rgba(59,130,246,.1); }
  ...
  _renderError() {
    return `<div class="error-msg">ERROR ${this._error}</div>`;
  }
    ...
    this.shadowRoot.innerHTML = `
      ...
      <h3>Energy Insights</h3>
            <div style="margin-bottom:12px;">
              ...
              <input type="text" id="cf_title" value="${this._config?.title || 'Energy Insights'}"
